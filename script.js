document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealElements = document.querySelectorAll(
        '.service-card, .client-card, .comparison-row, .testimonial-card, .faq-item, .info-card, .section-title, .section-subtitle, .section-label'
    );
    ...
    const serviceDetailsData = {
        ...
        'design': {
            ...
            gradient: 'linear-gradient(160deg, #2d1b3d 0%, #1a1a2e 100%)',
        ...
        'social': {
            ...
            gradient: 'linear-gradient(160deg, #1b2d3d 0%, #1a1a2e 100%)',
        ...
        'automation': {
            ...
            gradient: 'linear-gradient(160deg, #1b3d2d 0%, #1a1a2e 100%)',
        ...
        'web': {
            ...
            gradient: 'linear-gradient(160deg, #3d2d1b 0%, #1a1a2e 100%)',
        ...
        'seo': {
            label: 'SEO • SEO • SEO',
            title: 'Robust SEO',
            gradient: 'linear-gradient(160deg, #1a2e1a 0%, #1a1a2e 100%)',
